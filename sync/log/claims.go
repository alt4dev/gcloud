...
func (claims Claims) Print(v ...interface{}) (*proto.Result, error) {
	...
	return service.Log(false, message, claims.parse(), LEVEL.DEBUG).Result()
}
...
func (claims Claims) Info(v ...interface{}) (*proto.Result, error) {
	message := fmt.Sprint(v...)
	return service.Log(false, message, nil, LEVEL.INFO).Result()
}
...
func (claims Claims) Debug(v ...interface{}) (*proto.Result, error) {
	message := fmt.Sprint(v...)
	return service.Log(false, message, nil, LEVEL.DEBUG).Result()
}
...
func (claims Claims) Warning(v ...interface{}) (*proto.Result, error) {
	message := fmt.Sprint(v...)
	return service.Log(false, message, nil, LEVEL.WARNING).Result()
}
...
func (claims Claims) Error(v ...interface{}) (*proto.Result, error) {
	message := fmt.Sprint(v...)
	return service.Log(false, message, nil, LEVEL.ERROR).Result()
}
