...
func Print(v ...interface{}) {
	...
	service.Log(2, false, message, nil, nil, logging.Default, service.LogTime())
}
...
func Info(v ...interface{}) {
	message := fmt.Sprint(v...)
	service.Log(2, false, message, nil, nil, logging.Info, service.LogTime())
}
...
func Debug(v ...interface{}) {
	message := fmt.Sprint(v...)
	service.Log(2, false, message, nil, nil, logging.Debug, service.LogTime())
}
...
func Warning(v ...interface{}) {
	message := fmt.Sprint(v...)
	service.Log(2, false, message, nil, nil, logging.Warning, service.LogTime())
}
...
func Error(v ...interface{}) {
	message := fmt.Sprint(v...)
	service.Log(2, false, message, nil, nil, logging.Error, service.LogTime())
}
...
func Fatal(v ...interface{}) {
	message := fmt.Sprint(v...)
	service.Log(2, false, message, nil, nil, logging.Alert, service.LogTime())
	service.CloseGroup()
	BuiltInExit(1)
}
...
func Panic(v ...interface{}) {
	message := fmt.Sprint(v...)
	service.Log(2, false, message, nil, nil, logging.Critical, service.LogTime())
